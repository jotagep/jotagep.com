...
- **Use Cases**: Application-specific business rules. What can the user _do_?
- **Repository Interfaces (Ports)**: Contracts that define _how_ to access data, not _where_ it comes from.
...
Ports are the **contracts** between your domain and the outside world. They define what your domain _needs_, not how it's implemented.
